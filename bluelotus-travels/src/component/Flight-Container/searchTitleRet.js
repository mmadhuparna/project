...
class SearchtitleRet extends Component{
  ...
  render(){
    ...
    <div className="row rowleft ">
      <div className="col-md-6 titleret grey">
        <div className="row rowleft">
          <div className="col-md-4 col-xs-3 col-sm-3 vr">Departure </div>
          <div className="col-md-4 col-sm-3 col-xs-3 vr" >Arrival</div>
          <div className="col-md-4 col-sm-2 col-xs-2 vrr">Price</div>
        </div>
      </div>
      <div className="col-md-6 titleret grey">
        <div className="row rowleft">
